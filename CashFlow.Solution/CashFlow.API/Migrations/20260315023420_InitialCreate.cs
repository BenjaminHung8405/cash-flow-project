        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FundType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "FUND_MANAGE", "Quản lý quỹ" },
                    { "REPORT_VIEW", "Xem báo cáo" },
                    { "ROLE_MANAGE", "Quản lý vai trò" },
                    { "USER_MANAGE", "Quản lý người dùng" },
                    { "VOUCHER_CREATE", "Lập phiếu thu/chi" },
                    { "VOUCHER_VIEW", "Xem phiếu thu/chi" }
                });
